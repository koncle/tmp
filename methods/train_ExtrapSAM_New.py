...
class ExtrapLAWrapper():
    ...
    def SAM_LA_step(self, closure, inputs, LA_alpha=None, SAM_alpha=0.05, adaptive=False):
        ...
        prev_param, LA_dir = self._extrap_step(LA_alpha, do_LA=True, update=True)
        ...
        _, SAM_dir = self._extrap_step(SAM_alpha, do_LA=False, update=True, adaptive=adaptive)  # a        
...
if __name__ == "__main__":
    ...
    trainer.train()
# CUDA_VISIBLE_DEVICES=3 PYTHONPATH=.  python methods/train_ExtrapSAM_New.py --gpu 1 --dataset cifar100 --model resnet18 --alpha_scheduler constant --alpha 1