...
class VisionTransformer(nn.Module):
    ...
    def layer_wise_forward(self, x, idx=0):
...
#     return net
#     # return timm.create_model('vit_small_patch32_224', num_classes=num_classes, pretrained=False)
